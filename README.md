...
### "Translation failed"
- Translation feature gracefully falls back to English
- Check your internet connection
- MyMemory API might have rate limits

### Port already in use
- Change the port in `main.py` from 5000 to another number like 5001:
```python
app.run(debug=True, host='127.0.0.1', port=5001)
```

### "numpy.core.multiarray failed to import"
- This is usually due to NumPy version incompatibility with OpenCV
- Run: `pip install numpy<2`

## Performance Tips

- Fruit images work best at 800x600 resolution or higher
- JPEG format provides good quality-to-file-size ratio
- Upload times depend on API response (typically 5-10 seconds)
- Dark mode reduces eye strain for extended usage
